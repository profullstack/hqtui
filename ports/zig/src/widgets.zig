...
pub const shadow = @import("widgets/shadow.zig");
pub const world_map = @import("widgets/world.zig");
...
pub const WorldMapOptions = world_map.WorldMapOptions;
pub const drawWorldMap = world_map.drawWorldMap;
pub const countryAtCell = world_map.countryAtCell;
pub const ShadowOptions = shadow.ShadowOptions;
pub const dimRect = shadow.dimRect;
pub const drawShadow = shadow.drawShadow;
